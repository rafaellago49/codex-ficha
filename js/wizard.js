...
const CLASSES = [
  {
    ...
    equipment: {
      optionA: {
        ...
        items: [
          { name:'Machado de Grande', cat:'Armas', type:'Machado', qty:1, status:'Normal', desc:'2d6 cortante, Pesada, Duas mãos', wDmgType:'Cortante', wDice:'2d6', wRange:'Corpo a corpo', wAtk:'', wProps:'Pesada, Duas Mãos', weight:3.2 },
          { name:'Machadinha', cat:'Armas', type:'Machado', qty:2, status:'Normal', desc:'1d6 cortante, Leve, Arremesso', wDmgType:'Cortante', wDice:'1d6', wRange:'Ambos', wAtk:'', wProps:'Leve, Arremesso', weight:0.9 },
          { name:'Pacote de Explorador', cat:'Equipamentos', type:'Outros', qty:1, status:'Normal', desc:'Mochila, saco de dormir, kit de refeição, materiais de acampamento.', weight:27.5 }
        ],
        armorAC: null
      },
      optionB: {
        ...
        items: [
          { name:'Machadinha', cat:'Armas', type:'Machado', qty:2, status:'Normal', desc:'1d6 cortante, Leve, Arremesso', wDmgType:'Cortante', wDice:'1d6', wRange:'Ambos', wAtk:'', wProps:'Leve, Arremesso', weight:0.9 },
          { name:'Azagaia', cat:'Armas', type:'Lança', qty:4, status:'Normal', desc:'1d6 perfurante, Arremesso', wDmgType:'Perfurante', wDice:'1d6', wRange:'Ambos', wAtk:'', wProps:'Arremesso', weight:0.9 }
        ],
        armorAC: null
      }
    }
  },
  {
    ...
    equipment: {
      optionA: {
        ...
        items: [
          { name:'Rapieira', cat:'Armas', type:'Espada', qty:1, status:'Normal', desc:'1d8 perfurante, Finesse', wDmgType:'Perfurante', wDice:'1d8', wRange:'Corpo a corpo', wAtk:'', wProps:'Finesse', weight:0.9 },
          { name:'Armadura de Couro', cat:'Equipamentos', type:'Armadura', qty:1, status:'Equipado', desc:'CA 11 + mod DES', weight:5.0, aBaseAC:11, aType:'light' },
          { name:'Pacote do Diplomata', cat:'Equipamentos', type:'Outros', qty:1, status:'Normal', desc:'Baú, estojo de documentos, garrafa de tinta, pena, perfume.', weight:18.0 }
        ],
        armorAC: 11
      },
      optionB: {
        ...
        items: [
          { name:'Espada Longa', cat:'Armas', type:'Espada', qty:1, status:'Normal', desc:'1d8/1d10 cortante, Versátil', wDmgType:'Cortante', wDice:'1d8', wRange:'Corpo a corpo', wAtk:'', wProps:'Versátil (1d10)', weight:1.35 },
          { name:'Armadura de Couro', cat:'Equipamentos', type:'Armadura', qty:1, status:'Equipado', desc:'CA 11 + mod DES', weight:5.0, aBaseAC:11, aType:'light' },
          { name:'Pacote de Artista', cat:'Equipamentos', type:'Outros', qty:1, status:'Normal', desc:'Mochila, kit de fantasia, roupas, vela.', weight:10.0 }
        ],
        armorAC: 11
      }
    }
  },
  {
    ...
    equipment: {
      optionA: {
        ...
        items: [
          { name:'Maça', cat:'Armas', type:'Maça', qty:1, status:'Normal', desc:'1d6 contundente', wDmgType:'Contundente', wDice:'1d6', wRange:'Corpo a corpo', wAtk:'', wProps:'', weight:2.0 },
          { name:'Armadura de Escama', cat:'Equipamentos', type:'Armadura', qty:1, status:'Equipado', desc:'CA 14 + mod DES (máx 2)', weight:20.0, aBaseAC:14, aType:'medium' },
          { name:'Escudo', cat:'Equipamentos', type:'Escudo', qty:1, status:'Equipado', desc:'+2 CA', weight:3.0 },
          { name:'Símbolo Sagrado', cat:'Acessórios', type:'Amuleto', qty:1, status:'Equipado', desc:'Foco de conjuração sagrado.', weight:0.05 },
          { name:'Pacote do Padre', cat:'Equipamentos', type:'Outros', qty:1, status:'Normal', desc:'Mochila, cobertor, vela ×10, caixa de madeira, símbolo sagrado.', weight:15.5 }
        ],
        armorAC: 16
      },
      optionB: {
        ...
        items: [
          { name:'Maça', cat:'Armas', type:'Maça', qty:1, status:'Normal', desc:'1d6 contundente', wDmgType:'Contundente', wDice:'1d6', wRange:'Corpo a corpo', wAtk:'', wProps:'', weight:2.0 },
          { name:'Armadura de Couro', cat:'Equipamentos', type:'Armadura', qty:1, status:'Equipado', desc:'CA 11 + mod DES', weight:5.0, aBaseAC:11, aType:'light' },
          { name:'Besta Leve', cat:'Armas', type:'Arco', qty:1, status:'Normal', desc:'1d8 perfurante, Munição, Recarga', wDmgType:'Perfurante', wDice:'1d8', wRange:'Longa distância', wAtk:'', wProps:'Munição, Recarga', weight:2.5 },
          { name:'Virotes de Besta (20)', cat:'Utilizáveis', type:'Outros', qty:20, status:'Normal', desc:'', weight:0.75 },
          { name:'Símbolo Sagrado', cat:'Acessórios', type:'Amuleto', qty:1, status:'Equipado', desc:'Foco de conjuração sagrado.', weight:0.05 }
        ],
        armorAC: 11
      }
  ...
  },
  {
    ...
    equipment: {
      optionA: {
        ...
        items: [
          { name:'Escudo de Madeira', cat:'Equipamentos', type:'Escudo', qty:1, status:'Equipado', desc:'+2 CA', weight:3.0 },
          { name:'Cimitarra', cat:'Armas', type:'Espada', qty:1, status:'Normal', desc:'1d6 cortante, Finesse, Leve', wDmgType:'Cortante', wDice:'1d6', wRange:'Corpo a corpo', wAtk:'', wProps:'Finesse, Leve', weight:1.35 },
          { name:'Armadura de Couro', cat:'Equipamentos', type:'Armadura', qty:1, status:'Equipado', desc:'CA 11 + mod DES', weight:5.0, aBaseAC:11, aType:'light' },
          { name:'Foco Druídico', cat:'Acessórios', type:'Outros', qty:1, status:'Equipado', desc:'Bastão de madeira rúnica.', weight:1.8 },
          { name:'Pacote de Explorador', cat:'Equipamentos', type:'Outros', qty:1, status:'Normal', desc:'Mochila, kit de acampamento.', weight:27.5 }
        ],
        armorAC: 13
      },
      optionB: {
  ...
  },
  {
    ...
    equipment: {
      optionA: {
        ...
        items: [
          { name:'Cota de Malha', cat:'Equipamentos', type:'Armadura', qty:1, status:'Equipado', desc:'CA 16; Desvantagem em Furtividade', weight:27.5, aBaseAC:16, aType:'heavy' },
          { name:'Escudo', cat:'Equipamentos', type:'Escudo', qty:1, status:'Equipado', desc:'+2 CA', weight:3.0 },
          { name:'Espada Curta', cat:'Armas', type:'Espada', qty:1, status:'Normal', desc:'1d6 perfurante, Finesse, Leve', wDmgType:'Perfurante', wDice:'1d6', wRange:'Corpo a corpo', wAtk:'', wProps:'Finesse, Leve', weight:0.9 },
          { name:'Besta Leve', cat:'Armas', type:'Arco', qty:1, status:'Normal', desc:'1d8 perfurante, Munição, Recarga', wDmgType:'Perfurante', wDice:'1d8', wRange:'Longa distância', wAtk:'', wProps:'Munição, Recarga', weight:2.5 },
          { name:'Virotes de Besta (20)', cat:'Utilizáveis', type:'Outros', qty:20, status:'Normal', desc:'', weight:0.75 },
          { name:'Pacote do Aventureiro', cat:'Equipamentos', type:'Outros', qty:1, status:'Normal', desc:'Mochila, saco de dormir, kit de refeição.', weight:26.0 }
        ],
        armorAC: 18
      },
      optionB: {
        ...
        items: [
          { name:'Armadura de Couro', cat:'Equipamentos', type:'Armadura', qty:1, status:'Equipado', desc:'CA 11 + mod DES', weight:5.0, aBaseAC:11, aType:'light' },
          { name:'Arco Longo', cat:'Armas', type:'Arco', qty:1, status:'Normal', desc:'1d8 perfurante, Munição, Duas mãos', wDmgType:'Perfurante', wDice:'1d8', wRange:'Longa distância', wAtk:'', wProps:'Munição, Duas Mãos', weight:1.0 },
          { name:'Flecha (20)', cat:'Utilizáveis', type:'Outros', qty:20, status:'Normal', desc:'', weight:0.45 },
          { name:'Machado de Mão', cat:'Armas', type:'Machado', qty:2, status:'Normal', desc:'1d6 cortante, Leve, Arremesso', wDmgType:'Cortante', wDice:'1d6', wRange:'Ambos', wAtk:'', wProps:'Leve, Arremesso', weight:0.9 },
          { name:'Pacote do Aventureiro', cat:'Equipamentos', type:'Outros', qty:1, status:'Normal', desc:'', weight:26.0 }
        ],
        armorAC: 11
      }
    }
  },
  {
    ...
    equipment: {
      optionA: {
        ...
        items: [
          { name:'Espada Curta', cat:'Armas', type:'Espada', qty:1, status:'Normal', desc:'1d6 perfurante, Finesse, Leve', wDmgType:'Perfurante', wDice:'1d6', wRange:'Corpo a corpo', wAtk:'', wProps:'Finesse, Leve', weight:0.9 },
          { name:'Pacote de Explorador', cat:'Equipamentos', type:'Outros', qty:1, status:'Normal', desc:'', weight:27.5 },
          { name:'Dardo', cat:'Armas', type:'Adaga', qty:10, status:'Normal', desc:'1d4 perfurante, Arremesso, Leve', wDmgType:'Perfurante', wDice:'1d4', wRange:'Ambos', wAtk:'', wProps:'Arremesso, Leve', weight:0.11 }
        ],
        armorAC: null
      },
      optionB: {
        ...
        items: [
          { name:'Clava', cat:'Armas', type:'Maça', qty:1, status:'Normal', desc:'1d4 contundente, Leve', wDmgType:'Contundente', wDice:'1d4', wRange:'Corpo a corpo', wAtk:'', wProps:'Leve', weight:1.0 },
          { name:'Pacote do Aventureiro', cat:'Equipamentos', type:'Outros', qty:1, status:'Normal', desc:'', weight:26.0 },
          { name:'Dardo', cat:'Armas', type:'Adaga', qty:10, status:'Normal', desc:'1d4 perfurante, Arremesso, Leve', wDmgType:'Perfurante', wDice:'1d4', wRange:'Ambos', wAtk:'', wProps:'Arremesso, Leve', weight:0.11 }
        ],
        armorAC: null
    ...
    equipment: {
      optionA: {
        ...
        items: [
          { name:'Cota de Malha', cat:'Equipamentos', type:'Armadura', qty:1, status:'Equipado', desc:'CA 16; Desvantagem em Furtividade', weight:27.5, aBaseAC:16, aType:'heavy' },
          { name:'Escudo', cat:'Equipamentos', type:'Escudo', qty:1, status:'Equipado', desc:'+2 CA', weight:3.0 },
          { name:'Espada Longa', cat:'Armas', type:'Espada', qty:1, status:'Normal', desc:'1d8 cortante, Versátil (1d10)', wDmgType:'Cortante', wDice:'1d8', wRange:'Corpo a corpo', wAtk:'', wProps:'Versátil (1d10)', weight:1.35 },
          { name:'Azagaia', cat:'Armas', type:'Lança', qty:5, status:'Normal', desc:'1d6 perfurante, Arremesso', wDmgType:'Perfurante', wDice:'1d6', wRange:'Ambos', wAtk:'', wProps:'Arremesso', weight:0.9 },
          { name:'Símbolo Sagrado', cat:'Acessórios', type:'Amuleto', qty:1, status:'Equipado', desc:'Foco de conjuração sagrado.', weight:0.05 },
          { name:'Pacote do Padre', cat:'Equipamentos', type:'Outros', qty:1, status:'Normal', desc:'', weight:15.5 }
        ],
        armorAC: 18
      },
      optionB: {
  ...
  },
  {
    ...
    equipment: {
      optionA: {
        ...
        items: [
          { name:'Armadura de Escama', cat:'Equipamentos', type:'Armadura', qty:1, status:'Equipado', desc:'CA 14 + mod DES (máx 2)', weight:20.0, aBaseAC:14, aType:'medium' },
          { name:'Espada Curta', cat:'Armas', type:'Espada', qty:2, status:'Normal', desc:'1d6 perfurante, Finesse, Leve', wDmgType:'Perfurante', wDice:'1d6', wRange:'Corpo a corpo', wAtk:'', wProps:'Finesse, Leve', weight:0.9 },
          { name:'Pacote de Explorador', cat:'Equipamentos', type:'Outros', qty:1, status:'Normal', desc:'', weight:27.5 }
        ],
        armorAC: 14
      },
  ...
  },
  {
    ...
    equipment: {
      optionA: {
        ...
        items: [
          { name:'Rapieira', cat:'Armas', type:'Espada', qty:1, status:'Normal', desc:'1d8 perfurante, Finesse', wDmgType:'Perfurante', wDice:'1d8', wRange:'Corpo a corpo', wAtk:'', wProps:'Finesse', weight:0.9 },
          { name:'Besta de Mão', cat:'Armas', type:'Arco', qty:1, status:'Normal', desc:'1d6 perfurante, Munição, Leve, Recarga', wDmgType:'Perfurante', wDice:'1d6', wRange:'Longa distância', wAtk:'', wProps:'Munição, Leve, Recarga', weight:1.35 },
          { name:'Virotes de Besta (20)', cat:'Utilizáveis', type:'Outros', qty:20, status:'Normal', desc:'', weight:0.75 },
          { name:'Armadura de Couro', cat:'Equipamentos', type:'Armadura', qty:1, status:'Equipado', desc:'CA 11 + mod DES', weight:5.0, aBaseAC:11, aType:'light' },
          { name:'Ferramentas de Ladrão', cat:'Utilizáveis', type:'Ferramenta', qty:1, status:'Normal', desc:'', weight:0.45 },
          { name:'Pacote do Aventureiro', cat:'Equipamentos', type:'Outros', qty:1, status:'Normal', desc:'', weight:26.0 }
        ],
        armorAC: 11
      },
      optionB: {
        ...
        items: [
          { name:'Adaga', cat:'Armas', type:'Adaga', qty:2, status:'Normal', desc:'1d4 perfurante, Finesse, Leve, Arremesso', wDmgType:'Perfurante', wDice:'1d4', wRange:'Ambos', wAtk:'', wProps:'Finesse, Leve, Arremesso', weight:0.45 },
          { name:'Armadura de Couro', cat:'Equipamentos', type:'Armadura', qty:1, status:'Equipado', desc:'CA 11 + mod DES', weight:5.0, aBaseAC:11, aType:'light' },
          { name:'Ferramentas de Ladrão', cat:'Utilizáveis', type:'Ferramenta', qty:1, status:'Normal', desc:'', weight:0.45 },
          { name:'Pacote do Aventureiro', cat:'Equipamentos', type:'Outros', qty:1, status:'Normal', desc:'', weight:26.0 }
        ],
    ...
    equipment: {
      optionA: {
        ...
        items: [
          { name:'Besta Leve', cat:'Armas', type:'Arco', qty:1, status:'Normal', desc:'1d8 perfurante, Munição, Recarga', wDmgType:'Perfurante', wDice:'1d8', wRange:'Longa distância', wAtk:'', wProps:'Munição, Recarga', weight:2.5 },
          { name:'Virotes de Besta (20)', cat:'Utilizáveis', type:'Outros', qty:20, status:'Normal', desc:'', weight:0.75 },
          { name:'Foco Arcano', cat:'Acessórios', type:'Amuleto', qty:1, status:'Equipado', desc:'Cristal, varinha ou orbe focalizador.', weight:0.5 },
          { name:'Pacote do Aventureiro', cat:'Equipamentos', type:'Outros', qty:1, status:'Normal', desc:'', weight:26.0 }
        ],
        armorAC: null
      },
  ...
  },
  {
    ...
    equipment: {
      optionA: {
        ...
        items: [
          { name:'Bastão', cat:'Armas', type:'Maça', qty:1, status:'Normal', desc:'1d6 contundente, Versátil (1d8), Duas mãos', wDmgType:'Contundente', wDice:'1d6', wRange:'Corpo a corpo', wAtk:'', wProps:'Versátil (1d8)', weight:1.8 },
          { name:'Grimório', cat:'Utilizáveis', type:'Pergaminho', qty:1, status:'Normal', desc:'Contém 6 truques e 2 magias de 1º nível.', weight:1.5 },
          { name:'Bolsa de Componentes', cat:'Utilizáveis', type:'Outros', qty:1, status:'Normal', desc:'', weight:1.0 },
          { name:'Pacote do Acadêmico', cat:'Equipamentos', type:'Outros', qty:1, status:'Normal', desc:'Mochila, livro, tinta, pena, velas, kit de refeição.', weight:22.0 }
        ],
        armorAC: null
      },
      optionB: {
        ...
        items: [
          { name:'Adaga', cat:'Armas', type:'Adaga', qty:1, status:'Normal', desc:'1d4 perfurante, Finesse, Leve, Arremesso', wDmgType:'Perfurante', wDice:'1d4', wRange:'Ambos', wAtk:'', wProps:'Finesse, Leve, Arremesso', weight:0.45 },
          { name:'Foco Arcano', cat:'Acessórios', type:'Amuleto', qty:1, status:'Equipado', desc:'Cristal, varinha ou orbe focalizador.', weight:0.5 },
          { name:'Grimório', cat:'Utilizáveis', type:'Pergaminho', qty:1, status:'Normal', desc:'Contém 6 truques e 2 magias de 1º nível.', weight:1.5 },
          { name:'Pacote do Acadêmico', cat:'Equipamentos', type:'Outros', qty:1, status:'Normal', desc:'', weight:22.0 }
        ],
        armorAC: null
      }
    }
...
export const Wizard = (() => {
  ...
  function _emptyDraft() {
    return {
      ...
      selectedRaceSkills: [],  // race skill picks
  ...
  const _renderSkillPicker = () => {
    ...
    // 1. Bloco de Perícias de Classe
    const classPool = cls.skillPool === 'any' ? ALL_SKILLS : cls.skillPool;
    const classCount = cls.skillCount;
    const classChecks = classPool.map(sid => {
      const checked = _draft.selectedSkills.includes(sid);
      const disabled = !checked && _draft.selectedSkills.length >= classCount;
      return `
        <label class="choosable-check-label ${checked?'selected':''}" style="min-width:160px">
          <input type="checkbox" data-skill-class="${sid}" ${checked?'checked':''} ${disabled?'disabled':''}>
    ...
    let html = `
      <div class="choosable-bonus-section" style="border-color:var(--border-gold)">
        <p>Escolha <strong>${classCount}</strong> perícia${classCount>1?'s':''} da lista do ${cls.name}
          (${_draft.selectedSkills.length}/${classCount} selecionadas)</p>
        <div class="choosable-checkboxes">${classChecks}</div>
      </div>`;

    // 2. Bloco de Perícias Raciais (se aplicável)
    const rSkills = _draft.race?.choosableSkills;
    if (rSkills) {
      const racePool = rSkills.from === 'any' ? ALL_SKILLS : rSkills.from;
      const raceCount = rSkills.count;
      const raceChecks = racePool.map(sid => {
        const checked = (_draft.selectedRaceSkills || []).includes(sid);
        const disabled = !checked && (_draft.selectedRaceSkills || []).length >= raceCount;
        return `
          <label class="choosable-check-label ${checked?'selected':''}" style="min-width:160px">
            <input type="checkbox" data-skill-race="${sid}" ${checked?'checked':''} ${disabled?'disabled':''}>
            ${SKILL_LABELS[sid]||sid}
          </label>`;
      }).join('');

      html += `
        <div class="choosable-bonus-section mt-1" style="border-color:var(--arcane-bright)">
          <p style="color:var(--text-arcane)">Escolha <strong>${raceCount}</strong> perícia${raceCount>1?'s':''} extras da sua Raça
            (${(_draft.selectedRaceSkills || []).length}/${raceCount} selecionadas)</p>
          <div class="choosable-checkboxes">${raceChecks}</div>
        </div>`;
    }
  ...
  const _allProficientSkills = () => {
    ...
    (_draft.selectedRaceSkills || []).forEach(s => set.add(s)); // <- LINHA ADICIONADA
  ...
  const _validateStep = () => {
    switch (_step) {
      ...
      case 2: {
        ...
        // --- NOVA TRAVA RACIAL ---
        const raceNeeded = _draft.race?.choosableSkills?.count || 0;
        if (raceNeeded > 0 && (_draft.selectedRaceSkills || []).length !== raceNeeded) {
          Toast.show(`Selecione exatamente ${raceNeeded} perícia(s) de raça.`); return false;
        }
        // -------------------------
  ...
  const _finalize = () => {
    ...
    // ── HP — Nível 1: máx do dado + CON; níveis seguintes: médio + CON ──
    ...
    // nv1: hitDieMax + conMod; nv2+: +(floor(hitDieMax/2)+1+conMod) por nível
    ...
    if (_draft.equipChoice !== 'gold') {
      ...
      if (equip?.armorAC) {
        ...
        // Add shield if present (check by type, not name)
        const hasShield = (equip.items || []).some(i => i.type === 'Escudo');
        if (hasShield) ac += 2;
      }
    }
    ...
    if (_draft.equipChoice === 'gold') {
      ...
      (equip.items || []).forEach(i => {
        ...
        if (inv[cat]) {
          // Usa aBaseAC/aType já definidos no item; faz parse da desc só como fallback
          let aBaseAC = i.aBaseAC ?? null;
          let aType   = i.aType   ?? null;
          if (i.type === 'Armadura' && aBaseAC === null) {
            const d = (i.desc || '').toLowerCase();
            const match = d.match(/ca\s*(\d+)/);
            aBaseAC = match ? parseInt(match[1]) : 10;
            if (d.includes('máx 2')) aType = 'medium';
            else if (d.includes('mod des') && !d.includes('máx 2')) aType = 'light';
            else aType = 'heavy';
          }
    ...
    // Initialise spell slots based on class + level
    CharacterState.initSpellSlots();
  ...
  const _attachSubraceListeners = () => {
    document.querySelectorAll('[data-subrace-id]').forEach(card => {
      card.addEventListener('click', () => {
        ...
        document.querySelectorAll('[data-subrace-id]').forEach(c => {
  c.classList.remove('selected');
  c.style.borderColor = '';   // limpa o estilo inline de todos
});
card.classList.add('selected');
card.style.borderColor = 'var(--arcane-bright)';
  ...
  const _attachSkillPickListeners = () => {
    // Escutar cliques em Perícias de Classe
    document.querySelectorAll('[data-skill-class]').forEach(chk => {
      chk.addEventListener('change', () => {
        const sid = chk.dataset.skillClass;
        const count = _draft.classObj?.skillCount || 0;
        if (chk.checked) {
          if (_draft.selectedSkills.length >= count) {
            chk.checked = false;
            Toast.show(`Escolha apenas ${count} perícia(s) de classe.`); return;
          }
    ...
    // Escutar cliques em Perícias de Raça
    document.querySelectorAll('[data-skill-race]').forEach(chk => {
      chk.addEventListener('change', () => {
        const sid = chk.dataset.skillRace;
        const count = _draft.race?.choosableSkills?.count || 0;
        if (!_draft.selectedRaceSkills) _draft.selectedRaceSkills = [];
        
        if (chk.checked) {
          if (_draft.selectedRaceSkills.length >= count) {
            chk.checked = false;
            Toast.show(`Escolha apenas ${count} perícia(s) de raça.`); return;
          }
          _draft.selectedRaceSkills.push(sid);
        } else {
          _draft.selectedRaceSkills = _draft.selectedRaceSkills.filter(s => s !== sid);
        }
        const container = document.getElementById('skill-picker-container');
        if (container) { container.innerHTML = _renderSkillPicker(); _attachSkillPickListeners(); }
      });
